...
% Last Modified by GUIDE v2.5 06-Mar-2013 11:28:33
...
if (get(handles.ckLog , 'Value') ==1)
    ...
    switch get(handles.MacroMenu,'value')
        case 2
            msgbox('Pressure Sweep');
            PresSweep(CPC, tchamber,25, ip, handles);
        case 3
            msgbox('Pressure Histeresys');
            Pres_H(CPC, tchamber, 25, ip, handles);
        case 4
            msgbox('Temperature sweep');
            TempRamp(CPC, tchamber, 100, ip, handles);
        case 5
    ...
    switch get(handles.MacroMenu,'value')
        case 2
            msgbox('Pressure Sweep');
            PresSweep_nolog(CPC, tchamber,25, ip, handles);
        case 3
            msgbox('Pressure Histeresys');
            Pres_H_nolog(CPC, tchamber, 25, ip, handles);
        case 4
            msgbox('Temperature Ramp');
            TempRamp_nolog(CPC, tchamber, 100, ip, handles);
        case 5
            msgbox('Temperature Hysteresys');
